...
namespace PipLib.STRINGS
{
    public static class ELEMENTS
    {
        ...
        {
            public static readonly LocString NAME = FormatAsLink("Debug Element", nameof(DEBUGELEMENTSOLID));
        ...
        {
            public static readonly LocString NAME = FormatAsLink("Debug Element", nameof(DEBUGELEMENTLIQUID));
